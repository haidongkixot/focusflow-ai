...
The blog is for FocusFlow, a focus and productivity app with Pomodoro-style timers. Focus on productivity, deep work, focus techniques, time management, or work-life balance topics.`
  ...
  try {
    const { result, model, tokensUsed, durationMs } = await aiGenerate({
      ...
      metadata: { topic, tone },
      fallbackSystemPrompt: 'You are an expert content writer specializing in productivity, focus, and deep work. Return ONLY valid JSON, no markdown fences.',
    })
