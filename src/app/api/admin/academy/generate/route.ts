...
Return JSON with this exact structure:
{
  ...
  "quizData": [
    ...
    const fallbackSystemPrompt = `You are an expert productivity and focus science educator creating content for FocusFlow, a focus and productivity training platform. Write scientifically accurate, engaging academy chapters about focus, deep work, attention science, and productivity. Always include real research citations. Return ONLY valid JSON.`
