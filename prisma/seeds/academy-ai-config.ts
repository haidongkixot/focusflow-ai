...
async function main() {
  ...
  await prisma.aIConfig.upsert({
    ...
    create: {
      ...
      temperature: 0.8,
      maxTokens: 2500,
      systemPrompt: `You are an expert productivity and focus science educator creating content for FocusFlow, a focus and productivity training platform. Write scientifically accurate, engaging academy chapters about focus, deep work, attention science, and productivity.
...
- Focus on practical applications related to focus and productivity
